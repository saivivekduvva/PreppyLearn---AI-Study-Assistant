      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold text-neutral-900 tracking-tight">My Library & Uploads</h1>
          ...
          <div className="animate-fadeIn w-full flex flex-col gap-6">
            ...
            {extractedText && (
              <div className="flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-500">
                        ...
                        {processingStatus === 'success' && 'You can now start studying this document.'}
                ...
                {/* Massive CTA for Next Step */}
                {processingStatus === 'success' && (
                  <button 
                    onClick={() => navigate('/study')}
                    className="w-full group flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white p-6 rounded-2xl text-xl font-bold transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                  >
